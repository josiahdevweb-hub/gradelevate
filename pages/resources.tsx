...
const resources = [
  {
    ...
    items: [
      { title: "Ultimate Dissertation Writing Guide", desc: "Step-by-step breakdown of planning, structuring, and writing your dissertation.", tag: "PDF · 24 pages", free: true },
      { title: "PhD Application Success Blueprint", desc: "How to craft a compelling research proposal and personal statement.", tag: "PDF · 18 pages", free: false },
      { title: "Academic Job Market Guide", desc: "Navigating academic career paths, fellowships, and applications.", tag: "PDF · 16 pages", free: false },
      { title: "Postgraduate Funding Guide", desc: "Comprehensive list of UK and international funding sources for Masters and PhD.", tag: "PDF · 12 pages", free: true },
    ],
  },
  {
    category: "Templates",
    ...
    items: [
      { title: "Academic CV Template", desc: "Professional CV template designed for academic and research roles.", tag: "Word / PDF", free: true },
      { title: "Research Proposal Template", desc: "Structured template for Masters and PhD research proposals.", tag: "Word / PDF", free: false },
      { title: "Literature Review Matrix", desc: "Excel template for organising and synthesising research sources.", tag: "Excel", free: true },
      { title: "SMART Goal Setting Planner", desc: "Plan your academic semester with structured goal-setting and tracking.", tag: "PDF / Excel", free: false },
    ],
  },
  {
    category: "Checklists",
    ...
    items: [
      { title: "Dissertation Submission Checklist", desc: "Everything you need to verify before submitting your dissertation.", tag: "PDF · 2 pages", free: true },
      { title: "Job Application Checklist", desc: "Make sure your applications are complete, compelling, and error-free.", tag: "PDF · 1 page", free: true },
      { title: "PhD Viva Preparation Checklist", desc: "Step-by-step preparation guide for your doctoral viva examination.", tag: "PDF · 3 pages", free: false },
      { title: "Conference Presentation Checklist", desc: "Preparation guide for presenting your research at academic conferences.", tag: "PDF · 2 pages", free: false },
    ],
  },
];
              ...
              <div className={styles.resourceGrid}>
                {group.items.map((item, i) => (
                  <div key={i} className={styles.resourceCard}>
                    ...
                    <button className={item.free ? styles.downloadBtn : styles.premiumBtn}>
                      {item.free ? (
                        <>
