...
const credentials = [
  {
    ...
    label: "Senior Academic Leadership Experience",
  },
  {
    icon: (
      <svg width="28" height="28" fill="none" viewBox="0 0 28 28">
    ...
    label: "Postgraduate Supervision Experience",
  },
  {
    icon: (
      <svg width="28" height="28" fill="none" viewBox="0 0 28 28">
  ...
  },
  {
    ...
    label: "International Academic Collaboration",
  },
];
        ...
        <div className={styles.layout}>
          <div className={styles.imgCol}>
            <div className={styles.imgWrap}>
              <img
                src="/founders-scholars.jpg"
                alt="Academic leader teaching students in classroom"
